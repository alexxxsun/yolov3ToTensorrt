...
class DarkNetParser(object):
    ...
    def parse_cfg_file(self, cfg_file_path):
        ...
        with open(cfg_file_path) as cfg_file:
            ...
            remainder = remainder.encode('utf-8').decode('utf-8')   #add by alex
    ...
    def _next_layer(self, remainder):
        ...
        layer_param_block, remainder = remainder.split('#*', 1)
...
def main():
    ...
    '''
    cfg_file_path = '/home/contec/darknet-master/cfg/yolov3-tiny.cfg'
    ...
    '''
    weights_file_path = '/home/contec/darknet-master/yolov3-tiny.weights'
    ...
    output_file_path = 'yolov3_tiny.onnx'
