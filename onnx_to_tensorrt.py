...
def main():
    ...
    onnx_file_path = 'yolov3_tiny.onnx'
    engine_file_path = "yolov3_tiny.trt"
    ...
    '''
    input_image_path = '/home/contec/darknet-master/data/dog.jpg'
    # Two-dimensional tuple with the target network's (spatial) input resolution in HW ordered
    #input_resolution_yolov3_HW = (608, 608)
    input_resolution_yolov3_HW = (416,416) #SUNYL ADD
